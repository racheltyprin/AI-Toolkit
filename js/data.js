const toolsData = [
  ...
  { 
      "id": "julius",
      "name": "Julius AI",
      "tagline": "Chat with your data. Analyze spreadsheets, find patterns, and generate insights with AI.",
      "category": ["phase 1"],
      "pricing": "student",
      "hasTutorial": true,
      "logo": "https://www.google.com/s2/favicons?domain=julius.ai&sz=128",
      "desc": "AI data analyst that lets you upload spreadsheets or datasets and ask questions in plain English. Julius finds patterns, creates charts, runs analysis, and explains results without requiring Excel, SQL, or coding skills.",
      "url": "https://julius.ai/",
      "pricingDetails": "Free tier available with limited messages. Paid plans from ~$20/month.",
      "useCases": [
        "Analyzing spreadsheets without Excel formulas",
        "Finding trends and patterns in data",
        "Creating charts and visualizations",
        "Explaining data insights in plain language"
      ],
      "guide": [
        "<strong>Sign up:</strong> Go to julius.ai and create a free account",
        "<strong>Upload data:</strong> Drag and drop a CSV, Excel, or dataset",
        "<strong>Ask a question:</strong> Example: 'What trends do you see in monthly sales?'",
        "<strong>Review insights:</strong> Julius generates charts, statistics, and explanations",
        "<strong>Refine:</strong> Ask follow-up questions to explore deeper insights"
      ],
      "example": {
        "title": "Sales Trend Analysis",
        "goal": "Understand whats driving revenue changes over time.",
        "prompt": "Analyze this sales dataset and identify the top 3 factors affecting revenue growth.",
        "result": "A clear summary with visual charts showing seasonal trends, top-performing products, and key growth drivers."
      },
      "mistakes": [
        "Uploading messy data: Clean column names and remove empty rows for better results.",
        "Asking vague questions: Instead of 'Analyze this', ask something specific like 'Which customer segment has the highest lifetime value?'",
        "Ignoring context: Explain what the data represents to get more relevant insights."
      ],
      "useWhen": "You have a spreadsheet or dataset and want quick insights, charts, or pattern detection without learning data analysis tools.",
      "notUse": "Real-time dashboards or complex enterprise-scale data pipelines requiring database integrations.",
      "nextSteps": [
        "Upload a CSV or Excel file",
        "Ask a trend or comparison question",
        "Export charts for a presentation"
      ],
      "difficulty": "Easy",
      "product": "Data",
      "video": "https://www.youtube.com/watch?v=7C_K-VSYgnU",
      "keywords": [
        "data analysis",
        "AI data analyst",
    ...
    },
    {
      "id": "spline",
      "name": "Spline",
      "tagline": "Create 3D scenes, objects, and simple interactive experiences in your browser.",
      "category": ["phase 2","phase 3"],
      "pricing": "student",
      "hasTutorial": true,
      "logo": "https://www.google.com/s2/favicons?domain=spline.design&sz=128",
      "desc": "Browser-based 3D design tool to model, animate, and export 3D scenes. Browse a free gallery or use AI to quickly generate 3D models with a paid plan.",
      "url": "https://www.spline.design/",
      "pricingDetails": "Free to access basic 3D tools. <br> AI-generated 3D modeling requires a paid plan ($20-$25/month).",
      "useCases": [
        "Creating simple 3D models and scenes for web or presentations",
        "Prototyping interactive 3D experiences",
        "Rapid concepting of objects or environments",
        "Exporting 3D assets for web or AR/VR projects"
      ],
      "guide": [
        "<strong>Sign up:</strong> Go to spline.design and create a free account",
        "<strong>Explore:</strong> Browse the 3D model gallery and import assets",
        "<strong>Create:</strong> Add objects, shapes, and basic animations",
        "<strong>Use AI:</strong> For generative 3D models, upgrade to a paid plan",
        "<strong>Export:</strong> Download models or embed interactive 3D scenes"
      ],
      "example": {
        "title": "Interactive 3D Product Mockup",
        "goal": "Visualize a product in 3D with basic animation for a website demo",
        "prompt": "Generate a futuristic chair in 3D with metallic and wooden textures",
        "result": "A simple, interactive 3D chair model embedded in a web page."
      },
      "mistakes": [
        "Expecting precision: AI models won't follow exact dimensions or specs",
        "Overloading scenes: Browser-based 3D performance can lag with too many objects",
        "Ignoring animations: Simple drag-and-drop animations are best; complex physics may fail"
      ],
      "useWhen": "You need quick 3D concepts, interactive models, or web-ready 3D visuals without deep technical modeling skills.",
      "notUse": "Detailed CAD, engineering, or measurement-specific 3D modeling. Generative AI cannot reliably create objects with precise dimensions or complex assemblies yet.",
      "nextSteps": [
        "Browse the 3D gallery for inspiration",
        "Start a free scene and import objects",
        "Try AI generation if subscribed",
        "Export to web or presentation"
      ],
      "difficulty": "Medium",
      "product": "3D Modeling",
      "video": "https://www.youtube.com/watch?v=SzGEfYh9ITQ",
      "keywords": [
        "3D design",
        "interactive 3D",
        "AI 3D generation",
